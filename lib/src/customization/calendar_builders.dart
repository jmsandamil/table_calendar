...
typedef FullBuilder = Widget Function(BuildContext context, DateTime date, List events, List marks);
...
typedef FullListBuilder = List<Widget> Function(BuildContext context, DateTime date, List events, List marks, List holidays);
